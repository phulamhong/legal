...
Gửi email tới **legal@nextai.io** với:
...
1. Email **legal@nextai.io** mô tả tên hộ kinh doanh + mã số thuế + ngày đăng ký gần đúng
...
Email **legal@nextai.io** với tiêu đề `[KHIEU NAI XOA DU LIEU]` — phản hồi trong 7 ngày làm việc.
...
Email tài khoản: **xóa**. Email yêu cầu xóa dữ liệu (lưu trữ trong hộp thư legal@nextai.io): **giữ 5 năm** để chứng minh tuân thủ. Nội dung email được coi là thông tin nghiệp vụ, không phải dữ liệu cá nhân nữa sau khi xử lý xong.
...
| Mục đích | Email |
|---|---|
| Yêu cầu xóa dữ liệu | **legal@nextai.io** |
| Người bảo vệ dữ liệu (DPO) | phulamhong@gmail.com |
| Khiếu nại | legal@nextai.io |
