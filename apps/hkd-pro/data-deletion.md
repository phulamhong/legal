...
Gửi email tới **nextai.vn@gmail.com** với:
...
1. Email **nextai.vn@gmail.com** mô tả tên hộ kinh doanh + mã số thuế + ngày đăng ký gần đúng
...
Email **nextai.vn@gmail.com** với tiêu đề `[KHIEU NAI XOA DU LIEU]` — phản hồi trong 7 ngày làm việc.
...
Email tài khoản: **xóa**. Email yêu cầu xóa dữ liệu (lưu trữ trong hộp thư nextai.vn@gmail.com): **giữ 5 năm** để chứng minh tuân thủ. Nội dung email được coi là thông tin nghiệp vụ, không phải dữ liệu cá nhân nữa sau khi xử lý xong.
...
| Mục đích | Email |
|---|---|
| Yêu cầu xóa dữ liệu | **nextai.vn@gmail.com** |
| Người bảo vệ dữ liệu (DPO) | nextai.vn@gmail.com |
| Khiếu nại | nextai.vn@gmail.com |
